...
describe("Reserve a table functionality", () => {
  ...
  test("updateTimes works properly", () => {
    ...
    act(() => fireEvent.input(chooseDateElement, {target:{value: '2023-01-31'}}))
  ...
  test("Form Validations",async () => {
    const {getByLabelText, findByTestId, getAllByTestId , debug} = render(<MemoryRouter><Bookingpage/></MemoryRouter>)
    const chooseDateElement = getByLabelText("Choose date")
